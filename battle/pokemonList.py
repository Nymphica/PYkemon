...
squirtle = pokemon('SQUIRTLE', (tackle, tailwhip, bubble, watergun), 44, 48, 65, 64, 50, 43, ('water'))
bulbasaur = pokemon('BULBASAUR', (tackle, growl, vinewhip, growth), 45, 49, 49, 65, 65, 45, ('grass', 'poison'))

pokemonList = [pikachu, charmander, squirtle, bulbasaur, blastoise, charizard]