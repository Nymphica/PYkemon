...
squirtle1 = pokemon('SQUIRTLE', (tackle, tailwhip, bubble, watergun), 44, 48, 65, 64, 50, 43, ('water'))
bulbasaur1 = pokemon('BULBASAUR', (tackle, growl, vinewhip, growth), 45, 49, 49, 65, 65, 45, ('grass', 'poison'))
...
squirtle2 = pokemon('SQUIRTLE', (tackle, tailwhip, bubble, watergun), 44, 48, 65, 64, 50, 43, ('water'))
bulbasaur2 = pokemon('BULBASAUR', (tackle, growl, vinewhip, growth), 45, 49, 49, 65, 65, 45, ('grass', 'poison'))
